...
class ResultData(object):
    queries = {
        'definable_tags' : 'SELECT name, type, default_value FROM loader_config_tag WHERE user_definable=1;',
    ...
    def __get_run_config(self, runid):
        ''' return the loader config list for a run '''
    ...
    def __get_run_full_setting(self, runid=-1):
