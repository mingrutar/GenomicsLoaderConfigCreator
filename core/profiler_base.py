...
from utils.common import remake_path, check_x_mode, get_stats_path
from utils.constant_def import RUN_SCRIPT, CONFIG_DIRNAME

class ProfilerBase(object):
    def __init__(self, data_path):
        self.working_dir = os.environ.get('WS_HOME', os.getcwd())
